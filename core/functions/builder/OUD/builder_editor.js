...
function editModuleTekst(mod_id)
{
...
function start_editor(mod_id, module_tekst)
{
		...
		'<div class="mk_editor_module_galerij mk_editor_section">'+
			...
			'<div class="mk_editor_settings">' +
				...
				'<div class="opties mk_editor_section_thumbs">'+
					...
					'<div class="mk_editor_section_thumbnails_options_galerij"></div>'+
		...
		'<div class="mk_editor_module_video mk_editor_section">'+
			...
			'<div class="mk_editor_settings">'+
				...
				'<div class="opties videopath">'+
					...
					'<input id="videopath_0" type="radio" name="editor_videopath" value="1" checked=""><label for="videopath_0">Vimeo</label>' +

					'<input id="videopath_1" type="radio" name="editor_videopath" value="2"><label for="videopath_1">Youtube</label>' + 
...
function open_editor(mod_id, module_tekst)
{
	...
	else if(type_module == "video")
	{
		...
		//target view
		if(module_target == "" | module_target == null) { module_target = 1;}
...
function mk_editor_save_tekst()
{
	...
	else if(type_module == "knop")
	{
		...
		if( $('.mk_editor_settings .opties.mk_module_target_opties input[type=checkbox]').attr('checked') )
		{
		...
		if( $('.mk_editor_settings .opties.mk_module_extern_opties input[type=checkbox]').attr('checked') )
		{
