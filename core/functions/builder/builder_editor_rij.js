function changekoloms(value) { jQuery(function ($) {
...
function mk_editor_rij_append() { jQuery(function ($) {
...
function mk_editor_rij_open(rij_id)  { jQuery(function ($) {
...
function mk_editor_rij_close()  { jQuery(function ($) {
...
function mk_editor_rij_save() {	 jQuery(function ($) {
...
function mk_rij_add_koloms(sectie, id, newkoloms, koloms) { jQuery(function ($) {
...
function mk_rij_remove_koloms(sectie, id, newkoloms, koloms) { jQuery(function ($) {
